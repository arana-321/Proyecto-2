...
public class RegistroPersonal
{
    ...
    //
    public RegistroPersonal (int idPersonal, int ci, String nombre, String apellidoPaterno, String apellidoMaterno , String fechaNacimiento, String correoElectronico, String cargo, String direccion, String telefono)
    {
    ...
    //
    public RegistroPersonal (int idPersonal, int ci, String nombre)
    {
     this.idPersonal= idPersonal;
     this.ci= ci;
     this.nombre= nombre;
